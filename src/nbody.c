...
// Constant bodiess for bodies
const double masses[9] = {1.989E30, 3.301E23, 4.868E24, 5.972E24, 6.417E23, 1.898E27, 5.683E26, 8.681E25, 1.024E26};	// Masses in kg
...
typedef struct {
	double mass;		// Mass
	//double **hist;		// Previous positions
...
double step = 1;			// Time per step to simulate (d)
int year;					// Initial year of simulation
int size = 9;				// Number of bodies

void init_body(int body, double x, double y, double z, double vx, double vy, double vz) {
	bodies[body].mass = masses[body];
	bodies[body].x = x;
	bodies[body].y = y;
	bodies[body].z = z;
	bodies[body].vx = vx;
